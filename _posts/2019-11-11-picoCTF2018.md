...
I used this [tool](https://f00l.de/hacking/vigenere.php).
...
$ cat $(find . file 2>/dev/null) | grep picoCTF 
OR
$ grep "picoCTF" * -r          
...
![Logon]({{ site.baseurl }}/images/pico18/logon.png)
...
![Capture]({{ site.baseurl }}/images/pico18/wireshark.png)
...
```
![Magic]({{ site.baseurl }}/images/pico18/magic.png)
```
